...
- Compact mobile Journal: replaced the tall alternating image/text stack at the 390px breakpoint with four horizontal reading cards using fixed 108px thumbnails and 229px text columns. Individual cards now measure 156–164px and the complete index is approximately 906px tall, with no console errors. Added `#journal-index` for direct access and verification.
